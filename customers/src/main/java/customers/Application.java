...
public class Application {
	...
	public static void main(String[] args) {
		...
		AgeIterator<Customer> ageIterator = customerCollection.getAgeIterator();
		while (ageIterator.hasNext()){
			System.out.println(ageIterator.next());
		}

		System.out.println("*****************");
		AddressFilterIterator<Customer> cityIterator = customerCollection.getCityIterator();
		while (cityIterator.hasNext()){
			System.out.println(cityIterator.next());
		}

		System.out.println("*****************");
		AddressFilterIterator<Customer> zipcodeIterator = customerCollection.getZipcodIterator();
		while (zipcodeIterator.hasNext()){
			System.out.println(zipcodeIterator.next());
		}

		System.out.println("*****************");
		OddIterator<Customer> oddIterator = customerCollection.getOddIterator();
